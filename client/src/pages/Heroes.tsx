    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="mb-10">
          <Badge variant="primary" className="mb-3">Hero Directory</Badge>
          <h1 className="font-display text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-3">
            Discover <span className="gradient-text">Digital Heroes</span>
          </h1>
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl">
            Find and connect with {formatNumber(total || 0)} heroes building the digital future.
          </p>
        </motion.div>
